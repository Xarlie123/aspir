...
class UIPipelineHandler:
    def __init__(self, ui, simulacion, logger=None):
        self.ui = ui
        ...
        # Instanciar y embeder el PipelineControlWidget en el placeholder
        self.pipeline_widget = PipelineControlWidget(simulacion=self.simulation, logger=self.logger)
